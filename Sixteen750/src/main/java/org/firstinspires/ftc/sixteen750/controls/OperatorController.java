...
public class OperatorController {
    ...
    public CommandButton OutreachLaunchButton;
    public CommandButton OutreachLaunchFarButton;
    ...
    private void AssignNamedControllerButton() {
        ...
        OutreachLaunchButton = gamepad.leftBumper;
        OutreachLaunchFarButton = gamepad.rightBumper;
