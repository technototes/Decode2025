        ...
        CommandScheduler.scheduleForState(
            new AltAutoVelocity(robot).alongWith(
                new SequentialCommandGroup(
                    ...
                    new PedroPathCommand(robot.follower, p.RIntake2endtoLever, p.power2),
                    new WaitCommand(0.5),
                    new PedroPathCommand(robot.follower, p.RLevertoLaunch).alongWith(
                        TeleCommands.IntakeStop(robot)
                    ),
                    Paths.AutoLaunching3Balls(robot),
                    new PedroPathCommand(robot.follower, p.RlaunchtoRgateintake).alongWith(
                        TeleCommands.Intake(robot)
                    ),
                    new WaitCommand(1.5),
                    new PedroPathCommand(robot.follower, p.Rgateintaketolaunch),
                    Paths.AutoLaunching3Balls(robot),
                    ...
                    new PedroPathCommand(robot.follower, p.RIntake1endtoLaunch).alongWith(
                        TeleCommands.IntakeStop(robot)
                    ),
                    Paths.AutoLaunching3Balls(robot),
