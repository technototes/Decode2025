package org.firstinspires.ftc.rrquickstart.drive.opmode;

import static org.firstinspires.ftc.rrquickstart.drive.DriveConstants.MAX_RPM;
import static org.firstinspires.ftc.rrquickstart.drive.DriveConstants.RUN_USING_ENCODER;
import static org.firstinspires.ftc.rrquickstart.drive.DriveConstants.rpmToVelocity;
...
import org.firstinspires.ftc.rrquickstart.util.LoggingUtil;
import org.firstinspires.ftc.rrquickstart.util.RegressionUtil;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RegressionUtil.RampResult rampResult = RegressionUtil.fitRampData(
            ...
            LoggingUtil.getLogFile(
                Misc.formatInvariant("DriveRampRegression-%d.csv", System.currentTimeMillis())
            )
        );
        ...
        if (fitAccelFF) {
            ...
            RegressionUtil.AccelResult accelResult = RegressionUtil.fitAccelData(
                ...
                rampResult,
                LoggingUtil.getLogFile(
                    Misc.formatInvariant("DriveAccelRegression-%d.csv", System.currentTimeMillis())
                )
            );
            ...
            telemetry.addLine(
                Misc.formatInvariant("kA = %.5f (R^2 = %.2f)", accelResult.kA, accelResult.rSquare)
            );
            telemetry.update();
        }
