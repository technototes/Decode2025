...
import org.firstinspires.ftc.rrquickstart.drive.DriveConstants;
...
import org.firstinspires.ftc.rrquickstart.util.DashboardUtil;
import org.firstinspires.ftc.rrquickstart.util.LogFiles;
...
public class TrajectorySequenceRunner {
    ...
    public TrajectorySequenceRunner(
        ...
        List<Integer> lastDriveEncPositions,
        List<Integer> lastDriveEncVels,
    ...
    public @Nullable DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        if (currentTrajectorySequence != null) {
            ...
            if (currentTrajectorySequence == null) return new DriveSignal();
            ...
            if (isNewTransition) {
                ...
                Collections.sort(remainingMarkers, (t1, t2) ->
                    Double.compare(t1.getTime(), t2.getTime())
                );
            }
            ...
            if (currentSegment instanceof TrajectorySegment) {
                ...
                MotionState targetState = ((TurnSegment) currentSegment).getMotionProfile().get(
                    deltaTime
                );
