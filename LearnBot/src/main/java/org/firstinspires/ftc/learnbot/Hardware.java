...
public class Hardware implements Loggable {
    ...
    public DigitalSensor redSwitch, blueSwitch;
    ...
    public Hardware(HardwareMap hwmap) {
        ...
        redSwitch = new DigitalSensor(HardwareNames.ALLIANCE_SWITCH_RED);
        blueSwitch = new DigitalSensor(HardwareNames.ALLIANCE_SWITCH_BLUE);
    }
