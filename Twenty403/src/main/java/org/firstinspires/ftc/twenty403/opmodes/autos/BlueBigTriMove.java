...
@Configurable
@Autonomous(name = "BlueBigTriMove", preselectTeleOp = "Two Controller Drive \uD83D\uDDFF")
...
public class BlueBigTriMove extends CommandOpMode {
    ...
    public void uponInit() {
       ...
       robot.follower.setStartingPose(new Pose(34.133, 134.756, 270));
        bluesmalltobluegoal = robot.follower
                .pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(34.133, 134.756),
                                new Pose(51.556, 70.933),
                                new Pose(48.533, 58.133)
                        )
                )
